...
export const SEO: React.FC<SEOProps> = ({
  ...
  useEffect(() => {
    ...
    if (googleSiteVerification) {
      updateMetaTag('meta[name="google-site-verification"]', 'name', 'google-site-verification', googleSiteVerification.replace('meta=', '').replace('google-site-verification=', ''));
    }

  }, [title, description, canonicalUrl, imageUrl, type, listing, googleSiteVerification, lang]);
